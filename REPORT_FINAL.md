...
의혹의 "6쌍"은 우리가 찾은 사전투표 1·2위 동일쌍 **4~9쌍**과 같은 규모 — **현상 자체는 사실**입니다.
...
| 2 | (1401, 120) | 5명 | 광주 송정1동(1,737) ↔ 전남 고흥 금산면(1,646) | ❌ 다름 | 5.2% |
...
| 9 | (87, 72) | 3명 | 부산 금정 금성동(162) ↔ 강원 춘천 남면(159) | ❌ 다름 | 1.9% |

- **9쌍 중 5쌍은 서로 다른 시·도**(#2·6·7·8·9)끼리 — 후보가 전혀 다른 선거인데 숫자만 우연히 같은 것이라 조작으로 설명 불가. 나머지 4쌍도 대부분 농어촌 면(18개 투표소 중 12곳이 면, 1위값 9개 중 7개가 중앙값 1,094표 미만).
...
선거 내 기준으로도 관측(4) ≈ 기대(4.13). 인천·전남만 살짝 튀는데, 세 가지로 설명됩니다.

- **① "같은 조건"은 우연 일치를 줄이는 게 아니라 *늘립니다*.** 인천의 1쌍은 **송도1동 [3030, 1440, 61] vs 송도2동 [3030, 1440, 47]** — 총득표 4,531≈4,517의 **쌍둥이 신도시 동**입니다. 닮을수록 큰 숫자에서 겹치기 쉽고(3위는 61≠47로 다름, 완전 복제 아님), 시뮬레이션은 "인천 평균 지지율"을 써서 오히려 **p=0.028을 과소평가**합니다(송도끼리는 더 비슷). 전남 3쌍도 모두 득표 400~700표의 작은 면입니다.
- **② 다중비교:** 17개 시·도를 따로 검정하면 우연히 p<0.05가 평균 0.85개 나옵니다(17×0.05). 인천 1개가 정확히 그 노이즈이며, 보정하면 유의하지 않습니다.
- **③ "3쌍이 전남 한 곳에 몰릴 확률"**도 직접 계산했습니다: 전남에서 3쌍 이상 **6.9%**, 17개 시·도 중 어디든 3쌍 이상 **14.2%**(약 7번에 1번) — 드물지 않습니다. 전남에 몰린 건 **신안 섬 등 작은 면이 많아서**이지 조작이 아닙니다.
...
> **질문② 답:** 동일쌍은 **2026년만의 현상도, 특정 진영의 현상도 아닙니다.** 진보·보수가 이긴 모든 선거에서, 양 진영 텃밭 모두에서 나타나며, 늘 우연 기대값 이하입니다.
