...
| 프랑스 대선 2회 (2017·2022) | 투표소 **138,924개** | 프랑스 내무부 공개데이터 |

→ 합계 **24만 개가 넘는** 투표소·개표단위를 전수 분석했습니다(표본추출 없음).
...
|---|---|---|---|
| 2022 (마크롱) | 69,682 | **160,360쌍** | 384,160 |
| 2017 (마크롱) | 69,242 | **202,595쌍** | 579,970 |
...
| 가설의 조건 | 데이터가 보여주는 것 |
|---|---|
| **① 투표소가 많을수록 ↑** | (선거일 기준) 한국 대선 100~289쌍(투표구 1.4만) < 대만 815~2,395쌍(1.8만) < **프랑스 16만~20만쌍(7만)** |
